...
export function createSettingsPanel() {
    ...
    // linkLogosToText removed: с decoupled rendering logos have their own positions and
// never follow text. The compensating toggle no longer applies.
    ...
    document.getElementById('resetFrontSettingsBtn').addEventListener('click', function () {
        ...
        const backSettings = {
            ...
            backLogoPositions: settings.backLogoPositions ? { ...settings.backLogoPositions } : {}
        };
...
// Обновляем слайдеры
        ...
        settings.backLogoPositions = backSettings.backLogoPositions;
...
function getSettingsHTML() {
    return `
        ...
        -->
                    ...
                    <div class="setting-item">
                        <label>Размер логотипов: <span class="value backLogoSize">${settings.backLogoSize != null ? settings.backLogoSize.toFixed(1) : '1.0'}</span></label>
                        <input type="range" class="setting-slider" data-setting="backLogoSize" min="0.3" max="3" step="0.1" value="${settings.backLogoSize || 1.0}">
                    </div>
