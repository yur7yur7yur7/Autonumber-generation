...
export const DEFAULT_SETTINGS = {
    ...
    rusX: 14,
    rusY: 32,
    // flagX теперь хранится со знаком «−» (значение −19 даёт то же самое
    // фактическое положение флага, что и старый flagX=19 до инверсии в
    // drawing-front.js). Слайдер: «вправо → вправо», «влево → влево».
    flagX: -19,
    flagY: 1,
